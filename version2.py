...
def mostrarCartas(nombre):
    ...
    cartaCorrecta(nombre, posicionGanadora, posiciones)
...
def cartaCorrecta(nombre, posicionGanadora, posiciones):
    ...
    if opcionCarta == posicionGanadora:
        ...
        with open("puntajes.txt", "a") as puntaje:
            print(f"{nombre}, {puntosGanador} puntos. Jugada {fecha} {hora}", file=puntaje)#guardo en archivo
